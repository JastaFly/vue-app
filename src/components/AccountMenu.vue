...
<template>
  ...
  <router-link to="/articles/new" class="link" active-class="link__active">
    ...
    <span class="link__text">New Article</span>
  </router-link>
  <router-link class="link" to="/settings" active-class="link__active">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="link__icon">
