    ...
    <div class="banner banner_light">
      <div class="user">
        <img :src="userProfile.image"
             :alt="`Аватар пользователя ${userProfile.username}`"
             :title="`Аватар пользователя ${userProfile.username}`"
             class="user__ava">
      ...
      <button class="follow" v-if="isCurrent">
        <svg class="follow__icon follow__icon_gray" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
      ...
      <FollowButton v-if="!isCurrent" :user="userProfile" :current-store="userProfileStore"></FollowButton>
    </div>
